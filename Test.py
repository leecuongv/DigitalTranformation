...
class DichVu():
    def __init__(self, name, logo, qr, description):
        self.name = name
        self.logo = logo
        self.qr = qr
...
# CongBoCA = DichVu("Cổng thông tin Dịch vụ Công Bộ CA" )

listDichVu = []
Cong = ["Cổng Thông tin dịch vụ bộ công an", "Cổng thông tin dịch vụ công quốc gia", "VN"]
ThanhToan = ["Momo", ]
