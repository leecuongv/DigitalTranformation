...
while True:
    ...
    img, bbox = cvzone.putTextRect(img, "Momo", [100, 100], 2, 2, offset=50, border=5)
    img, bbox1 = cvzone.putTextRect(img, "Test", [100, 250], 2, 2, offset=50, border=5)
